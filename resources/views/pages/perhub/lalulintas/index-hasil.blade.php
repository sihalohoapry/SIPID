                    ...
                    <div class="page-hero page-container " id="page-hero">
                        <div class="padding d-flex pt-0">
                            <div class="page-title">
                                <h2 class="text-md text-highlight">Hasil Pembangunan di Bidang Lalu Lintas</h2>
                                <small class="text-muted">Daftar list seluruh hasil kegiatan</small>
                            </div>
                            <div class="flex"></div>
                            <div>
                                <a href="{{ route('create-hasil-kegiatan', ["perhubungan","lalu-lintas"]) }}" class="btn btn-md text-muted">
...
<script>
    ...
    var datatable = $('#datatable').DataTable({
            ...
            buttons: [
            {
                ...
                title:' DATA HASIL PEMBANGUNAN BIDANG LALU LINTAS ',
                exportOptions: {
