                    ...
                    <div class="page-hero page-container " id="page-hero">
                        <div class="padding d-flex pt-0">
                            <div class="page-title">
                                <h2 class="text-md text-highlight">Progres Kegiatan di Bidang Binamarga</h2>
                                <small class="text-muted">Daftar list seluruh proses kegiatan</small>
                            </div>
                            <div class="flex"></div>
                            <div>
                                <a href="{{ route('create-progres-kegiatan', ["pupr","binamarga"]) }}" class="btn btn-md text-muted">
