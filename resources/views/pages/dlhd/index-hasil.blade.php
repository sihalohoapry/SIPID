                    ...
                    <div class="page-hero page-container " id="page-hero">
                        <div class="padding d-flex pt-0">
                            <div class="page-title">
                                <h2 class="text-md text-highlight">Hasil Pembangunan di Bidang Pengolahan Sampah & Pertamanan</h2>
                                <small class="text-muted">Daftar list seluruh hasil kegiatan</small>
                            </div>
                            <div class="flex"></div>
                            <div>
                                <a href="{{ route('create-hasil-kegiatan', ["dinas-lingkungan-hidup","pengolahan-sampah-dan-pertamanan"]) }}" class="btn btn-md text-muted">
